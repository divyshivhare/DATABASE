...
$host = "localhost";
        ...
        {   
            ...
            $sql = "INSERT INTO `Coursse_complete` (`Un_id`, `Course_id` ,`Sy`) VALUES ('NULL','DBMS','$SyDBMS')";
            $result = mysqli_query($conn, $sql);

            $sql = "INSERT INTO `Coursse_complete` (`Un_id`, `Course_id` ,`Sy`) VALUES ('NULL','MI','$SyMI')";
            $result = mysqli_query($conn, $sql);

            $sql = "INSERT INTO `Coursse_complete` (`Un_id`, `Course_id` ,`Sy`) VALUES ('NULL','CN','$SyCN')";
            $result = mysqli_query($conn, $sql);

            $sql = "INSERT INTO `Coursse_complete` (`Un_id`, `Course_id` ,`Sy`) VALUES ('NULL','DSA','$SyDSA')";
            $result = mysqli_query($conn, $sql);

            $sql = "INSERT INTO `Coursse_complete` (`Un_id`, `Course_id` ,`Sy`) VALUES ('NULL','TIS','$SyTIS')";
            $result = mysqli_query($conn, $sql);
